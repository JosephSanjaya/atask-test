package atask.sanjaya.math.location.presentation.adapter
...
import atask.sanjaya.math.location.databinding.LayoutRowCityBinding
    ...
    override fun convert(
        ...
        holder.dataBinding?.apply {
            ...
            btnFavorite.setImageResource(
                if (item.isFavorite)
                    atask.sanjaya.ui.R.drawable.baseline_favorite_24 else
                    atask.sanjaya.ui.R.drawable.baseline_favorite_border_24
            )
        }
    }
